    ...
    if (message.content.toLowerCase().startsWith("!message")) {
      try {
        ...
        const evoGraphEmbed = {
          ...
          image: {
            url: "https://media.discordapp.net/attachments/1338654104486150256/1338687603251085476/2.png?ex=67b33dbc&is=67b1ec3c&hm=8158807c341182ed2c0d3baeacce9f6fe32b491d5043ddf9bc96f41763812859&=&format=webp&quality=lossless&width=1058&height=378", // استبدل هذا برابط الصورة التي تريد عرضها
          },
          description:
